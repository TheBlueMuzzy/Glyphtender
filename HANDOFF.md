...
- **P0: Play Again button breaks hand state** - After a game (tested in 4p local), choosing "Play Again" results in broken hand during placement. Letters from previous round visible (mixed player colors), non-interactable. Need cleaner reset.
