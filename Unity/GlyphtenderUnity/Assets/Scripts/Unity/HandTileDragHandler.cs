    ...
    public class HandTileDragHandler : MonoBehaviour
    {
        ...
        private void OnMouseDown()
        {
            ...
            if (_isQuadPrefab)
            {
                ...
                float boardTileSize = BoardRenderer.Instance != null ? BoardRenderer.Instance.hexSize * 1.5f : 1.35f;
            ...
            // Note: Don't apply ghost appearance during drag - keep tile solid and visible
            // The texture uses Unlit/Transparent Cutout which doesn't support alpha blend
            // This matches glyphling behavior (solid during drag)
